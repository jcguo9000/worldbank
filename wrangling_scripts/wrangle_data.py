...
country_default = OrderedDict([('Brazil', 'BRA'), ('Russia', 'RUS'), ('India', 'IND'), ('China', 'CHN'), ('South Afica', 'ZAF') ])
...
def return_figures(countries=country_default):
  ...
  # World Bank indicators of interest for pulling data
    indicators = ['NY.GDP.MKTP.CD', 'SP.POP.GROW', 'SP.RUR.TOTL.ZS', 'AG.LND.FRST.ZS','SI.POV.DDAY','NE.EXP.GNFS.ZS','SP.URB.TOTL.IN.ZS','TM.VAL.FUEL.ZS.UN']
  ...
  #df_three.sort_values('value', ascending=False, inplace=True)
    ...
    layout_three = dict(title = 'Annual Population Growth of BRICS countries <br> from 1900 to 2015',
                xaxis = dict(title = 'Year',
                  autotick=False, tick0=1990, dtick=5),
  ...
  #df_three.sort_values('value', ascending=False, inplace=True)
    ...
    layout_five = dict(title = 'Poverty Headcount Ratio at $1.90/day (2011 PPP) <br> of BRICS countries from 1990 to 2015',
                xaxis = dict(title = 'Year',
                  autotick=False, tick0=1990, dtick=5),
                yaxis = dict(title = 'Percent'),
                )
  ...
  #df_three.sort_values('value', ascending=False, inplace=True)
    ...
    layout_six = dict(title = 'Export of Service and Goods (% of GDD) <br> of BRICS countries from 1990 to 2015',
                xaxis = dict(title = 'Year',
                  autotick=False, tick0=1990, dtick=5),
                yaxis = dict(title = 'Percent'),
                )
    ...
    layout_seven = dict(title = 'Urban population (% of total population) <br> of BRICS countries from 1990 to 2015',
                xaxis = dict(title = 'Year',
                  autotick=False, tick0=1990, dtick=5),
                yaxis = dict(title = 'Percent'),
                )
    ...
    layout_eight = dict(title = 'Fuel imports (% of merchandise imports) <br> of BRICS countries from 1990 to 2015',
                xaxis = dict(title = 'Year',
                  autotick=False, tick0=1990, dtick=5),
                yaxis = dict(title = 'Percent'),
                )
